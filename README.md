...
The original repo is [here](https://github.com/rmurphey/js-assessment). This is my Fork where I solved all the test. I solved them first by using my own knowledge of JS, secondly by referencing [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript), a very few times when really stumped I looke for help on StackOverflow. I commented on my solutions pointing twoard the resources I used to solve the test. 
